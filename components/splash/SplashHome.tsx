 ...
 *
 * 그 위로 창 하나가 올라와 첫 선물을 알린다. 읽기 화면이 검으므로 이 창도 검다 —
 * 감상노트 창과 같은 결이다.
 */
    ...
    <View style={styles.screen}>
      ...
      <Animated.View
        ...
        <View style={styles.body}>
          ...
          <Animated.Text
            entering={FadeInDown.delay(RISE_MS).duration(320)}
          ...
          <Animated.View entering={FadeInDown.delay(RISE_MS + 180).duration(320)}>
            ...
            <Text style={styles.line}>
              무료로 <Text style={styles.lineMark}>{FREE_LESSONS}화 미리보기</Text>를
            </Text>
            <Text style={styles.line}>넣어드렸어요.</Text>
          </Animated.View>

          <Animated.Text entering={FadeInDown.delay(RISE_MS + 270).duration(320)} style={styles.note}>
...
const styles = StyleSheet.create({
  ...
  /** 글월 안에서 이 대목만 주황으로 — 선물이 무엇인지 한눈에 걸리게 한다. */
  lineMark: {
    color: Spark.ember,
  },
  note: {
